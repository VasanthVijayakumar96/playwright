...
Then("the login page form should be visible", async function (this: FoodDeliveryWorld) {
...
When("I login with valid credentials", async function (this: FoodDeliveryWorld) {
...
Then("the navbar profile should be visible", async function (this: FoodDeliveryWorld) {
  await expect(this.page.locator(".navbar-profile")).toBeVisible({
    timeout: 10000
  });
});

Then("the logged out navbar should be visible", async function (this: FoodDeliveryWorld) {
  await expect(this.page.locator('[data-testid="navbar-signin"]')).toBeVisible();
  await expect(this.page.locator('[data-testid="navbar-signup"]')).toBeVisible();
});
...
When("I logout via navbar", async function (this: FoodDeliveryWorld) {
  ...
  await expect(this.page.locator('[data-testid="navbar-signout"]')).toBeVisible({
    timeout: 5000
  });
...
Then("I should remain on the application origin", async function (this: FoodDeliveryWorld) {
