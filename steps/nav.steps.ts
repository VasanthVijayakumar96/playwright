...
When("I click the navbar Sign in button", async function (this: CustomWorld) {
  await this.page.locator('[data-testid="navbar-signin"]').click();
  await this.page.waitForURL(/\/login$/, { timeout: 8000 });
});

When("I click the navbar Sign up button", async function (this: CustomWorld) {
...
Then(
  ...
  async function (this: CustomWorld, suffix: string) {
...
Then("the page should still render", async function (this: CustomWorld) {
